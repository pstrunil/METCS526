...
NOTE: The pseudocode section looks different once you look at the preview, so if you want to see it in a more comprehensive form, please download this file and check it out in the text editor. 
